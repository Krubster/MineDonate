...
public class ItemInfo extends Merch {
    ...
    public ItemInfo(int _shopId, int _catId, int mid, int _rating, int cos, String n, int lim, java.sql.Blob data) {
        ...
        if(stack_data != null)
        m_stack = new ItemStack(stack_data);
        else
            System.out.println("Error loading item stack: null!");
    ...
    public String getSearchValue() {
        ...
        return TextFormatting.getTextWithoutFormattingCodes(name) + (m_stack != null ? TextFormatting.getTextWithoutFormattingCodes(m_stack.getDisplayName()) : "");
