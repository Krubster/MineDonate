...
public class EntityInfo extends Merch {
    ...
    public void read(ByteBuf buf) {
        ...
        try {
            entity = (EntityLivingBase) Class.forName(classpath).getDeclaredConstructor(net.minecraft.world.World.class).newInstance(Minecraft.getMinecraft().world);
    ...
    public String getSearchValue() {
        ...
        return TextFormatting.getTextWithoutFormattingCodes(name);
