...
public class EntitiesCategory extends ShopCategory {
    ...
    public void updateButtons(ShopGUI g, int page) {
        ...
        g.getButtonList().add(addButton = new GuiGradientButton(ShopGUI.getNextButtonId(), rightButton.x - MineDonate.cfgUI.cats.entities.addButton.width, rightButton.y, MineDonate.cfgUI.cats.entities.addButton.width, MineDonate.cfgUI.cats.entities.addButton.height, MineDonate.cfgUI.cats.entities.addButton.text, false));
