...
public class GuiItemEntryOfItemMerch extends GuiAbstractItemEntry {
    ...
    public void draw(GuiItemsScrollArea gi, int x_offset, int y_offset, int xRightOffset, float partialTicks, int mouseX, int mouseY, Tessellator var5, DrawType dt, int index, int size) {
        ...
        if (dt == DrawType.PRE) {
            ...
            gi.parent.getItemRender().renderItemAndEffectIntoGUI(info.m_stack, 0, 0);
    ...
    public void renderItemOverlayIntoGUI(FontRenderer p_94148_1_, TextureManager p_94148_2_, ItemStack p_94148_3_, int p_94148_4_, int p_94148_5_, String p_94148_6_, boolean t) {
        if (p_94148_3_ != null) {
            if (t) {
                ...
                if (p_94148_3_.getCount() > 1 || p_94148_6_ != null) {
                    String s1 = p_94148_6_ == null ? String.valueOf(p_94148_3_.getCount()) : p_94148_6_;
                    GL11.glDisable(GL11.GL_LIGHTING);
    ...
    private void renderQuad(Tessellator p_77017_1_, int p_77017_2_, int p_77017_3_, int p_77017_4_, int p_77017_5_, int p_77017_6_) {
        ...
        */
        BufferBuilder bb =     p_77017_1_.getBuffer();
        bb.begin(7, DefaultVertexFormats.POSITION_TEX);

        bb.pos((double) (p_77017_2_ + 0), (double) (p_77017_3_ + 0), 0.0D).endVertex();
        bb.pos((double) (p_77017_2_ + 0), (double) (p_77017_3_ + p_77017_5_), 0.0D).endVertex();
        bb.pos((double) (p_77017_2_ + p_77017_4_), (double) (p_77017_3_ + p_77017_5_), 0.0D).endVertex();
        bb.pos((double) (p_77017_2_ + p_77017_4_), (double) (p_77017_3_ + 0), 0.0D).endVertex();
    ...
    public GuiAbstractItemEntry addButtons(ShopGUI gui) {
        ...
        min = new CountButton(-1, info, ShopGUI.getNextButtonId(), buy.x - 1 - 16, -100, 16, 20, "-");
        min.setEntityOnUpdate(this);

        gui.addButton(min, false);

        pl = new CountButton(1, info, ShopGUI.getNextButtonId(), min.x - 1 - 16, -100, 16, 20, "+");
