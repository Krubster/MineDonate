...
public abstract class GuiScrollingList {
    ...
    protected abstract void drawSlot(int var1, int var2, int var3, int var4, float partialTicks, int mouseX, int mouseY, Tessellator var5, DrawType dt);
    ...
    public void drawScreen(int mouseX, int mouseY, float p_22243_3_, DrawType dt) {
        ...
        if (dt == DrawType.PRE) {
            ...
            if (this.client.world == null) {
                ...
                BufferBuilder bufferbuilder = var18.getBuffer();
                bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX);

                bufferbuilder.pos((double) this.left, (double) this.bottom, 0.0D).tex((double) ((float) this.left / var17), (double) ((float) (this.bottom + (int) this.scrollDistance) / var17)).endVertex();
                bufferbuilder.pos((double) this.right, (double) this.bottom, 0.0D).tex((double) ((float) this.right / var17), (double) ((float) (this.bottom + (int) this.scrollDistance) / var17)).endVertex();
                bufferbuilder.pos((double) this.right, (double) this.top, 0.0D).tex((double) ((float) this.right / var17), (double) ((float) (this.top + (int) this.scrollDistance) / var17)).endVertex();
                bufferbuilder.pos((double) this.left, (double) this.top, 0.0D).tex((double) ((float) this.left / var17), (double) ((float) (this.top + (int) this.scrollDistance) / var17)).endVertex();
            ...
            for (var11 = 0; var11 < listLength; ++var11) {
                ...
                if (var19 + 22/*#LOG*/ <= this.bottom && var19 + var13 - 36/*#LOG*/ >= this.top - 2) {
                    if (this.field_25123_p && this.isSelected(var11)) {
                        ...
                        bufferbuilder.pos((double) var14, (double) (var19 + var13 + 2), 0.0D).tex(0, 1).endVertex();
                        bufferbuilder.pos((double) var15, (double) (var19 + var13 + 2), 0.0D).tex(1, 1).endVertex();
                        bufferbuilder.pos((double) var15, (double) (var19 - 2), 0.0D).tex(1, 0).endVertex();
                        bufferbuilder.pos((double) var14, (double) (var19 - 2), 0.0D).tex(0, 0).endVertex();
                        //                        var18.setColorOpaque_I(0); WTF??!?!
                        bufferbuilder.pos((double) (var14 + 1), (double) (var19 + var13 + 1), 0.0D).tex(0, 1).endVertex();
                        bufferbuilder.pos((double) (var15 - 1), (double) (var19 + var13 + 1), 0.0D).tex(1, 1).endVertex();
                        bufferbuilder.pos((double) (var15 - 1), (double) (var19 - 1), 0.0D).tex(1, 0).endVertex();
                        bufferbuilder.pos((double) (var14 + 1), (double) (var19 - 1), 0.0D).tex(0, 0).endVertex();
                        var18.draw();
                        GL11.glEnable(GL11.GL_TEXTURE_2D);
                    }

                    this.drawSlot(var11, boxRight, var19, var13, p_22243_3_, mouseX, mouseY, var18, DrawType.PRE);
            ...
            for (var11 = 0; var11 < listLength; ++var11) {
                ...
                var13 = this.slotHeight;
                if (var19 + 22/*#LOG*/ <= this.bottom && var19 + var13 - 36/*#LOG*/ >= this.top - 2) {
                    this.drawSlot(var11, boxRight, var19, var13, p_22243_3_, mouseX, mouseY, var18, DrawType.POST);
                }
            }
            ...
            if (var19 > 0) {
                ...
                */
                ...
                //                var18.setColorRGBA_I(0, 255);
                bufferbuilder.pos((double) scrollBarXStart, (double) this.bottom, 0.0D).tex(0, 1).endVertex();
                bufferbuilder.pos((double) scrollBarXEnd, (double) this.bottom, 0.0D).tex(1, 1).endVertex();
                bufferbuilder.pos((double) scrollBarXEnd, (double) this.top, 0.0D).tex(1, 0).endVertex();
                bufferbuilder.pos((double) scrollBarXStart, (double) this.top, 0.0D).tex(0, 0).endVertex();
                var18.draw();
                //                var18.setColorRGBA_I(8421504, 255);
                bufferbuilder.pos((double) scrollBarXStart, (double) (var14 + var13), 0.0D).tex(0, 1).endVertex();
                bufferbuilder.pos((double) scrollBarXEnd, (double) (var14 + var13), 0.0D).tex(1, 1).endVertex();
                bufferbuilder.pos((double) scrollBarXEnd, (double) var14, 0.0D).tex(1, 0).endVertex();
                bufferbuilder.pos((double) scrollBarXStart, (double) var14, 0.0D).tex(0, 0).endVertex();
                var18.draw();
                //               var18.setColorRGBA_I(12632256, 255);
                bufferbuilder.pos((double) scrollBarXStart, (double) (var14 + var13 - 1), 0.0D).tex(0, 1).endVertex();
                bufferbuilder.pos((double) (scrollBarXEnd - 1), (double) (var14 + var13 - 1), 0.0D).tex(1, 1).endVertex();
                bufferbuilder.pos((double) (scrollBarXEnd - 1), (double) var14, 0.0D).tex(1, 0).endVertex();
                bufferbuilder.pos((double) scrollBarXStart, (double) var14, 0.0D).tex(0, 0).endVertex();
                var18.draw();
            }
            ...
            for (var11 = 0; var11 < listLength; ++var11) {
                ...
                var13 = this.slotHeight;
                if (var19 + 22/*#LOG*/ <= this.bottom && var19 + var13 - 36/*#LOG*/ >= this.top - 2) {
                    this.drawSlot(var11, boxRight, var19, var13, p_22243_3_, mouseX, mouseY, var18, DrawType.OVERLAY_PRE);
                }
            }
            ...
            for (var11 = 0; var11 < listLength; ++var11) {
                ...
                var13 = this.slotHeight;
                if (var19 + 22/*#LOG*/ <= this.bottom && var19 + var13 - 36/*#LOG*/ >= this.top - 2) {
                    this.drawSlot(var11, boxRight, var19, var13, p_22243_3_, mouseX, mouseY, var18, DrawType.OVERLAY_POST);
                }
            }
    ...
    private void overlayBackground(int p_22239_1_, int p_22239_2_, int p_22239_3_, int p_22239_4_) {
        ...
        var5.draw();
        */
        BufferBuilder bufferbuilder = var5.getBuffer();
        // var5.setColorRGBA_I(4210752, p_22239_4_);
        bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX);

        bufferbuilder.pos(0.0D, (double) p_22239_2_, 0.0D).tex(0.0D, (double) ((float) p_22239_2_ / var6)).endVertex();
        bufferbuilder.pos((double) this.listWidth + 30, (double) p_22239_2_, 0.0D).tex((double) ((float) (this.listWidth + 30) / var6), (double) ((float) p_22239_2_ / var6)).endVertex();
        //        var5.setColorRGBA_I(4210752, p_22239_3_);
        bufferbuilder.pos((double) this.listWidth + 30, (double) p_22239_1_, 0.0D).tex((double) ((float) (this.listWidth + 30) / var6), (double) ((float) p_22239_1_ / var6)).endVertex();
        bufferbuilder.pos(0.0D, (double) p_22239_1_, 0.0D).tex(0.0D, (double) ((float) p_22239_1_ / var6)).endVertex();
        var5.draw();
    }
