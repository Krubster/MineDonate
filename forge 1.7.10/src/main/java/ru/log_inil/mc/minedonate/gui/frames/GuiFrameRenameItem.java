...
public class GuiFrameRenameItem extends GuiEntry {
	...
	DataOfUIFrameRenameItem douifri ;

	int shopId = -1, catId = -1, merch_id = -1 ;
	
	public GuiFrameRenameItem ( DataOfUIFrameRenameItem _douifri ) {
